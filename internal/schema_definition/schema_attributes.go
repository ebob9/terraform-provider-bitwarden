...
const (
	...
	AttributeAttachmentDataHash            = "content_hash"
	...
	DescriptionItemAttachmentDataHash        = "Calculated SHA1 hash of the attachment. This can be specified to ensure update of attachment if changed on disk."
	DescriptionItemAttachmentFileName        = "File name. This is required if specifying `content` in a resource."
